    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="{{route('dashboard')}}">
                ...
                <img src="{{asset('/')}}admin/assets/images/brand/1idea_bulb.png" class="header-brand-img light-logo1"
                     alt="logo">
            </a>
            <!-- LOGO -->
                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
												<span>
													<img src="{{asset( Auth::user()->photo )}}" alt="profile-user"
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <a class="dropdown-item" href="{{route('home')}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                            <path d="M12,2 L2,12 L3.41,13.41 L5,12 L5,22 L19,22 L19,12 L20.59,13.41 L22,12 L12,2 Z M7,18 L7,14 L17,14 L17,18 L12,18 L12,22 L10,22 L10,18 L7,18 Z"/>
                                        </svg>
                                        Home
                                    </a>
                                    <a class="dropdown-item" href="{{ route('profile.show', Crypt::encryptString(Auth::user()->id)) }}">
