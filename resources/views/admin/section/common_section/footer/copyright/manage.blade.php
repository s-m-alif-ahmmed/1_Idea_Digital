            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> Manage Copyright </li>
{{--                        <li class="breadcrumb-item active" aria-current="page">--}}
{{--                            <a href="{{ route('copyright.create') }}" class="btn btn-outline-secondary justify-content-between">--}}
{{--                                Add New Copyright--}}
{{--                            </a>--}}
{{--                        </li>--}}
                    </ol>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                        <a href="{{route('copyright.show', Crypt::encryptString($copyright->id))}}" class="text-primary mx-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Views"><i class="fa fa-eye"></i></a>
                                        <a href="{{route('copyright.edit', Crypt::encryptString($copyright->id))}}" class="text-warning mx-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="fa fa-edit"></i></a>
