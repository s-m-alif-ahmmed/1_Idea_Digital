                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 ">
                            <form class="row g-3" method="post" action="{{route('term.update', Crypt::encryptString($term->id) )}}">
                                @csrf
                                @method('patch')

                                <div class="col-12">
                                    <label for="name" class="form-label"> Terms & Conditions </label>
                                    <textarea class="form-control" type="text" name="name" id="summernote" placeholder="Enter terms & conditions" required >{{ $term->name }}</textarea>
                                </div>
