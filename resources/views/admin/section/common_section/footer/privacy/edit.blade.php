            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <h5 class="mb-0">Edit Privacy</h5>
                    </div>
                    <div class="card-body">
                        <div class="border p-3 ">
                            <form class="row g-3" method="post" action="{{route('privacy.update', Crypt::encryptString($privacy->id) )}}">
                                @csrf
                                @method('patch')

                                <div class="col-12">
                                    <label for="name" class="form-label"> Privacys & Conditions </label>
                                    <textarea class="form-control" type="text" name="name" id="summernote" placeholder="Enter privacy policy" required >{{ $privacy->name }}</textarea>
                                </div>
