            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> Add New Privacy </li>
            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <h5 class="mb-0">Add New Privacy </h5>
                    </div>
                    <div class="card-body">
                        <div class="border p-3 ">
                            <form class="row g-3" method="post" action="{{route('privacy.store')}}">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" type="text" name="name" id="summernote" placeholder="Enter privacy policy" required ></textarea>
                                </div>
