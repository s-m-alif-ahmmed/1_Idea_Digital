                        ...
                        <div class="border p-3 ">
                            <form class="row g-3" method="post" action="{{route('service.store')}}">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" type="text" name="icon" id="icon" placeholder="Enter service icon code" required ></textarea>
                                </div>

                                <div class="col-12">
                                    <label class="form-label"> Service Description </label>
                                    <textarea class="form-control" type="text" name="detail" placeholder="Enter service detail" required ></textarea>
                                </div>
