            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> Add New Package Sub Heading </li>
            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-header py-3 bg-transparent">
                        <h5 class="mb-0">Add New Package Sub Heading </h5>
                    </div>
                    <div class="card-body">
                        <div class="border p-3 ">
                            <form class="row g-3" method="post" action="{{route('packageSubHeading.store')}}">
                                @csrf
                                @method('post')
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    <select class="form-control select2 form-select" name="service_id" data-placeholder="Choose one service" required>
                                        @foreach($services as $service)
                                            ...
                                            <option value="{{ $service->id }}" {{$service->package_sub_heading_id == $service->id ? 'selected' : ''}} >{{ $service->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="text" name="name" id="name" placeholder="Enter package sub heading name" required />
                                </div>

                                <div class="col-12">
                                    <label class="form-label"> Package Sub Heading Description </label>
                                    <textarea class="form-control" type="text" name="description" id="summernote" placeholder="Enter package sub heading description " required ></textarea>
                                </div>
